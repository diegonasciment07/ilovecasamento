...
const icons: Record<string, ReactElement> = {
  ...
  cofrinho: (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M23 12v-3" stroke={G} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M20 9h8" stroke={G} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M22 26h4" stroke={G} strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  ),
  vaquinha: (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M24 22v4" stroke={G} strokeWidth="1.8" strokeLinecap="round" />
      <path d="M20 26l4-4 4 4" stroke={G} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18 36l2-4h8l2 4" stroke={G} strokeWidth="1.2" strokeLinecap="round" />
      <path d="M15 20l-3-4M33 20l3-4" stroke={G} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  sofa: (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  carro: (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="14" y1="22" x2="34" y2="22" stroke={G} strokeWidth="1" strokeLinecap="round" opacity=".4" />
    </svg>
  ),
  lavanderia: (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// ─── Card ───────────────────────────────────────────────────────────────────
function PresenteCard({ item }: { item: Presente }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-3 gap-1.5">
        <p
          ...
          style={{ fontSize: '0.875rem', color: '#1E1208' }}
        >
          {item.nome}
        </p>
        <p
          className="font-sans font-light leading-tight"
          style={{ fontSize: '0.68rem', color: '#8B6B50', letterSpacing: '0.01em' }}
        >
          {item.nota}
        </p>
        <div className="mt-auto pt-2">
          <span
            ...
            style={{
              ...
              letterSpacing: '0.2em',
              color: '#B87040',
              backgroundColor: 'rgba(184,112,64,0.08)',
              padding: '3px 8px',
    ...
    <div className="min-h-screen">
      ...
      <section className="px-6 pt-12 pb-4 max-w-lg mx-auto">
        {categorias.map((cat, i) => (
          <div
            key={cat.nome}
            className={i < categorias.length - 1 ? 'mb-14' : 'mb-6'}
          >
            <p
              className="section-label pb-3 mb-5"
              style={{ borderBottom: '2px solid #B87040' }}
            >
              {cat.nome}
            </p>
            <div className="grid grid-cols-2 gap-3">
              {cat.itens.map((item) => (
                <PresenteCard key={item.nome} item={item} />
              ))}
            </div>
          </div>
        ))}
      ...
      {/* PIX */}
      <section className="px-6 max-w-lg mx-auto" style={{ borderTop: '1px solid #D0C2B0', paddingTop: '3rem', paddingBottom: '4rem', textAlign: 'center' }}>
